    ...
    <>
      <div className="w-full">
        <div className="flex w-full">
            ...
            <div className="w-full">
            <button
              onClick={() => deleteAllProperty(property)}
              type="button"
              className="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900 ml-10 mt-5"
            >
              Delete All Property
            </button>
          <div className="property-flex property-flex2 w-full">
            {property.map((val) => {
              return (
                <>
                  <PropertyItem
